...
//        listen();
     ...
     * @return
     */
    public String get(String address_str, String oid_str){
        init();
        String ret = "";    
        //构造PDU
        PDU pdu = new PDU();
     ...
     * @return
     */
    public String getNext(String address_str, String oid_str){
        init();
        String ret = "";
        //构造PDU
        PDU pdu = new PDU();
     ...
     * @return
     */
    public List<String> getBulk(String address_str, String oid_str){
        init();
...
//            System.out.println("pdu_rec.size() = " + pdu_rec.size());
     ...
     */
    @Override
    public void sendMessage(String address_str, String message) {
        //构造trap PDU
        PDU pdu = new PDU();
	...
	{	
		Snmp_api api=new Snmp_api();
		System.out.println(api.getNext("udp:127.0.0.1/4700", ".1.3.6.1.2.1.1.4.0"));
